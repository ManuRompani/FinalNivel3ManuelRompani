...
function validarPerfil() {
    ...
    var validar = function (campo, mensaje, formato) {
        if (!formato.test(campo.value) && campo != "") {
            campo.classList.remove("is-valid");
            campo.classList.add("is-invalid");
    ...
    var validarNombre = validar(nombre, mensajeNombre, /^[a-zA-Z\s]*$/);
    var validarApellido = validar(apellido, mensajeApellido, /^[a-zA-Z\s]*$/);
...
function validarCategoriaMarca() {
    var descripcion = document.getElementById('tboxDescripcion');
